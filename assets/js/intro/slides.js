...
jQuery(function ($) {
  ...
  const descriptions = [
    ...
    `پس من ، که یه نصف اپ هستم ، به عنوان یه هدیه اومدم برای کمک ، بیا با هم یه راه ساده رو طی کنیم تا بتونیم بنویسیم :))`,
    ...
    `پای راستت که برمی‌داری ، مطالعه کردن و خوندنه.
        ...
        <br />
        پای راست تو توی این مسیر ، مطالعه کردن تو هستش که به دست خودته ولی بیشتر از چیزی که فکرش رو می‌کنی مهمه! پس همین الان ، یه کتاب انتخاب کن و شروع کن به خوندن.
        <br />
